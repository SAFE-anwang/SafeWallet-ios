...
extension HudHelper {
    enum BannerType {
        ...
        var color: UIColor {
            ...
            case .addedToWallet, .copied, .saved, .savedToCloud, .done, .restored, .created, .imported, .walletAdded, .enabled, .success, .connectedWalletConnect, .passwordFromKeychain, .liquidity: return .themeRemus
