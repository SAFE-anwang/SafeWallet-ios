...
class FallbackBlockViewController: ThemeActionSheetController {
    ...
    private func onSelect(index: Int) {
        let viewController = BottomSheetModule.fallbackBlockConfirmation { [weak self] in
            self?.onSelect(index)
...
extension FallbackBlockViewController: SectionsDataSource {
