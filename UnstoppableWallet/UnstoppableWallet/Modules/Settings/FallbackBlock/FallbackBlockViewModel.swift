...
class FallbackBlockViewModel {
    ...
    lazy var fallbackBlockViewItems: [FallbackBlockViewItem] = {
        let item0 = FallbackBlockViewItem(date: .date_202309, item: SelectorModule.ViewItem(title: "safe_setting.fallbackBlock".localized("5178101（2023-9）"), selected: false))
        let item1 = FallbackBlockViewItem(date: .date_202306, item: SelectorModule.ViewItem(title: "safe_setting.fallbackBlock".localized("4939318（2023-6）"), selected: false))
        let item2 = FallbackBlockViewItem(date: .date_202304, item: SelectorModule.ViewItem(title: "safe_setting.fallbackBlock".localized("4656085（2023-4）"), selected: false))
        let item3 = FallbackBlockViewItem(date: .date_202302, item: SelectorModule.ViewItem(title: "safe_setting.fallbackBlock".localized("4581517（2023-2）"), selected: false))
