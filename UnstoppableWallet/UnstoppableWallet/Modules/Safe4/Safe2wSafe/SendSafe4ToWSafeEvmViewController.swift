...
class SendSafe4ToWSafeEvmViewController: ThemeViewController {
    private let evmKitWrapper: EvmKitWrapper
    private let viewModel: SendSafe4ToWSafeViewModel
    ...
    init(evmKitWrapper: EvmKitWrapper, viewModel: SendSafe4ToWSafeViewModel, availableBalanceViewModel: ISendAvailableBalanceViewModel, amountViewModel: AmountInputViewModel, recipientViewModel: RecipientAddressViewModel) {
...
extension SendSafe4ToWSafeEvmViewController: SectionsDataSource {
