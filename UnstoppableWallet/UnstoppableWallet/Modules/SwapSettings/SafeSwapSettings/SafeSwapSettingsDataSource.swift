...
class SafeSwapSettingsDataSource: ISwapSettingsDataSource {
    private let disposeBag = DisposeBag()

    private let viewModel: SafeSwapSettingsViewModel
    ...
    init(viewModel: SafeSwapSettingsViewModel, recipientViewModel: RecipientAddressViewModel, slippageViewModel: SwapSlippageViewModel) {
...
extension SafeSwapSettingsDataSource {
