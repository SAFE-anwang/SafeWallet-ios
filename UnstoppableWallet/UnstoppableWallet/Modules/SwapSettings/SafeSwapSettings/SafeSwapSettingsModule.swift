...
struct SafeSwapSettingsModule {

    static func dataSource(tradeService: SafeSwapTradeService) -> ISwapSettingsDataSource? {
        ...
        let service = SafeSwapSettingsService(settings: tradeService.settings, addressService: addressService)
        let viewModel = SafeSwapSettingsViewModel(service: service, tradeService: tradeService)
        ...
        return SafeSwapSettingsDataSource(
                viewModel: viewModel,
