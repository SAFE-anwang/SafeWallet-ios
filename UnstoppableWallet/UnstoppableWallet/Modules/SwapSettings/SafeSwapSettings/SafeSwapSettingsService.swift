...
class SafeSwapSettingsService {
    ...
    init(settings: SafeSwapSettings, addressService: AddressService) {
...
extension SafeSwapSettingsService {
...
extension SafeSwapSettingsService: ISlippageService {
