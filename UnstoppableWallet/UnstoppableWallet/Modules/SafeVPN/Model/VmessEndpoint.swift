...
//        endpoint != nil ? try container.encode(endpoint, forKey: .endpoint) : nil
//        uid != nil ? try container.encode(uid, forKey: .uid) : nil
...
//        endpoint = (values.contains(.endpoint) == true) ? try values.decode(String.self, forKey: .endpoint) : nil
//        uid = (values.contains(.uid) == true) ? try values.decode(String.self, forKey: .uid) : nil
