...
class LiquidityDataSource {
    ...
    private let viewModel: LiquidityViewModel
    ...
    init(viewModel: LiquidityViewModel, allowanceViewModel: LiquidityAllowanceViewModel) {
    ...
    private func handle(revokeActionState: LiquidityViewModel.ActionState) {
    ...
    private func handle(proceedActionState: LiquidityViewModel.ActionState) {
        handle(actionState: proceedActionState, button: proceedButton)
        handle(actionState: proceedActionState, button: proceed2Button)
    }

    private func handle(approveActionState: LiquidityViewModel.ActionState) {
        handle(actionState: approveActionState, button: approve1Button)
    }

    private func handle(actionState: LiquidityViewModel.ActionState, button: PrimaryButton) {
        switch actionState {
        case .hidden:
...
extension LiquidityDataSource: ILiquidityDataSource {
...
extension LiquidityDataSource: IPresentDelegate {
...
extension LiquidityDataSource: ISwapApproveDelegate {
...
extension LiquidityDataSource: IDynamicHeightCellDelegate {
