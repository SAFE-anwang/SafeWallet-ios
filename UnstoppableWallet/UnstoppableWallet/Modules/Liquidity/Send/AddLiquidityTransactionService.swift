...
protocol IAddLiquidityTransactionService {
    var state: AddLiquidityTransactionService.State { get }
    var stateObservable: Observable<AddLiquidityTransactionService.State> { get }

    var dataState: AddLiquidityTransactionService.DataState { get }

    var sendState: AddLiquidityTransactionService.SendState { get }
    var sendStateObservable: Observable<AddLiquidityTransactionService.SendState> { get }
...
class AddLiquidityTransactionService {
...
extension AddLiquidityTransactionService: IAddLiquidityTransactionService {
...
extension AddLiquidityTransactionService {
