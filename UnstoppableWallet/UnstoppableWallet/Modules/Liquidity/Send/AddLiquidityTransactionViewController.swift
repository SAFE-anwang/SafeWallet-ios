...
class AddLiquidityTransactionViewController: ThemeViewController {
    let disposeBag = DisposeBag()

    let transactionViewModel: AddLiquidityTransactionViewModel
    ...
    private var sectionViewItems = [AddLiquidityTransactionViewModel.SectionViewItem]()
    ...
    init(transactionViewModel: AddLiquidityTransactionViewModel, settingsViewModel: EvmSendSettingsViewModel) {
...
//        }
    ...
    private func row(viewItem: AddLiquidityTransactionViewModel.ViewItem, rowInfo: RowInfo) -> RowProtocol {
        switch viewItem {
    ...
    private func section(sectionViewItem: AddLiquidityTransactionViewModel.SectionViewItem, index: Int) -> SectionProtocol {
...
extension AddLiquidityTransactionViewController: SectionsDataSource {
