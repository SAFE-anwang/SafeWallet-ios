...
class LiquidityCoinSelectViewController: ThemeSearchViewController {
    private let viewModel: LiquidityCoinSelectViewModel
    private weak var delegate: ICoinSelectDelegate?
    private let disposeBag = DisposeBag()

    private let tableView = SectionsTableView(style: .grouped)
    private var viewItems = [LiquidityCoinSelectViewModel.ViewItem]()

    init(viewModel: LiquidityCoinSelectViewModel, delegate: ICoinSelectDelegate) {
    ...
    private func handle(viewItems: [LiquidityCoinSelectViewModel.ViewItem]) {
...
extension LiquidityCoinSelectViewController: SectionsDataSource {
