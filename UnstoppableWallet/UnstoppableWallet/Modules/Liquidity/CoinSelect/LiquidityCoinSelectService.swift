...
class LiquidityCoinSelectService {
    private let dex: LiquidityMainModule.Dex
    ...
    init(dex: LiquidityMainModule.Dex, marketKit: MarketKit.Kit, walletManager: WalletManager, adapterManager: AdapterManager, currencyManager: CurrencyManager) {
        self.dex = dex
...
extension LiquidityCoinSelectService {
