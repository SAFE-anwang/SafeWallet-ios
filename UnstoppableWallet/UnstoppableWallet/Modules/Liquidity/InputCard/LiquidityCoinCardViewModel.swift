...
class LiquidityCoinCardViewModel {
    private let coinCardService: ILiquidityCoinCardService
    ...
    init(coinCardService: ILiquidityCoinCardService, fiatService: FiatService) {
...
extension LiquidityCoinCardViewModel {
