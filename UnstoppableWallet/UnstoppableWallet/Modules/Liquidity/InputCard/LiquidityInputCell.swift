...
class LiquidityInputCell: UITableViewCell {
    ...
    init(fromViewModel: LiquidityCoinCardViewModel, fromAmountInputViewModel: AmountInputViewModel, toViewModel: LiquidityCoinCardViewModel, toAmountInputViewModel: AmountInputViewModel) {
        fromInputCard = LiquidityInputCardView(viewModel: fromViewModel, amountInputViewModel: fromAmountInputViewModel, isTopView: true)
        toInputCard = LiquidityInputCardView(viewModel: toViewModel, amountInputViewModel: toAmountInputViewModel, isTopView: false)
        ...
        fromInputCard.snp.makeConstraints { maker in
            ...
            maker.height.equalTo(LiquidityInputCardView.lineHeight)
        }
