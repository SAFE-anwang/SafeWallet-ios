...
class LiquidityInputCardView: UIView {
    ...
    private let viewModel: LiquidityCoinCardViewModel
    ...
    init(viewModel: LiquidityCoinCardViewModel, amountInputViewModel: AmountInputViewModel, isTopView: Bool) {
...
extension LiquidityInputCardView {
    ...
    private func set(tokenViewItem: LiquidityCoinCardViewModel.TokenViewItem?) {
...
extension LiquidityInputCardView: ICoinSelectDelegate {
