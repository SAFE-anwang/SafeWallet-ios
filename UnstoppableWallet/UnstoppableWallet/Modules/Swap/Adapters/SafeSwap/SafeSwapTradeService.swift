...
//
//        do {
//            let tradeData = try safeSwapProvider.tradeData(swapData: swapData, amount: amount, tradeType: tradeType, tradeOptions: settings.tradeOptions)
//            handle(tradeData: tradeData)
//            return true
//        } catch {
//            var error = error
//
//            if case SafeSwapKit.Kit.TradeError.tradeNotFound = error {
//                let wethAddressString = safeSwapProvider.wethAddress.hex
//
//                if case .native = tokenIn?.type, case .eip20(let address) = tokenOut?.type, address == wethAddressString {
//                    error = SafeSwapModule.TradeError.wrapUnwrapNotAllowed
//                }
//
...
//        try safeSwapProvider.transactionData(tradeData: tradeData)
//    }
//
...
//                switch priceImpact {
//                case 0..<SafeSwapTradeService.warningPriceImpact: return .normal
//                case SafeSwapTradeService.warningPriceImpact..<SafeSwapTradeService.forbiddenPriceImpact: return .warning
