...
//import EvmKit
//
//class SafeSwapViewModel {
//    private let disposeBag = DisposeBag()
//
//    public let service: SafeSwapService
//    public let tradeService: SafeSwapTradeService
//    public let switchService: AmountTypeSwitchService
//    private let currencyKit: CurrencyKit.Kit
//    private let allowanceService: SwapAllowanceService
//    private let pendingAllowanceService: SwapPendingAllowanceService
//
//    private let viewItemHelper: SafeSwapViewItemHelper
//
//    private var availableBalanceRelay = BehaviorRelay<String?>(value: nil)
//    private var priceImpactRelay = BehaviorRelay<SafeSwapModule.PriceImpactViewItem?>(value: nil)
...
//
//    init(service: SafeSwapService, tradeService: SafeSwapTradeService, switchService: AmountTypeSwitchService, allowanceService: SwapAllowanceService, pendingAllowanceService: SwapPendingAllowanceService, currencyKit: CurrencyKit.Kit, viewItemHelper: SafeSwapViewItemHelper) {
...
//    }
//
//    private func sync(state: SafeSwapService.State? = nil) {
...
//            switch error {
//            case let error as SafeSwapKit.Kit.TradeError: return error != .zeroAmount
...
//    }
//
//    private func sync(tradeState: SafeSwapTradeService.State) {
//        var loading = false
//        switch tradeState {
//        case .loading:
//            loading = true
...
//    }
//
//    private func sync(swapSettings: SafeSwapSettings) {
...
//    }
//
//    private func settingsViewItem(settings: SafeSwapSettings) -> SettingsViewItem {
...
//    }
//
//    var priceImpactDriver: Driver<SafeSwapModule.PriceImpactViewItem?> {
...
//        }
//
//        let swapInfo = SendEvmData.SafeSwapInfo(
...
//                transactionData: transactionData, additionalInfo: .safeSwap(info: swapInfo),
//                warnings: trade.impactLevel == .forbidden ? [SafeSwapModule.SafeSwapWarning.highPriceImpact] : []
//        )
//
...
//        let priceImpact: SafeSwapModule.PriceImpactViewItem?
//        let guaranteedAmount: SafeSwapModule.GuaranteedAmountViewItem?
//    }
//
...
class SafeSwapViewModel {
    ...
    private var approveActionRelay = BehaviorRelay<ActionState>(value: .hidden)
    private var approveStepRelay = BehaviorRelay<SwapModule.ApproveStepState>(value: .notApproved)
    private var openConfirmRelay = PublishRelay<SafeSwapParameters>()
    private var amountTypeIndexRelay = BehaviorRelay<Int>(value: 0)
    private var isAmountToggleAvailableRelay = BehaviorRelay<Bool>(value: false)
    ...
    init(service: SafeSwapService, tradeService: SafeSwapTradeService, switchService: AmountTypeSwitchService, allowanceService: SwapAllowanceService, pendingAllowanceService: SwapPendingAllowanceService, currencyKit: CurrencyKit.Kit, viewItemHelper: SwapViewItemHelper) {
        self.service = service
        self.tradeService = tradeService
        self.switchService = switchService
        self.allowanceService = allowanceService
    ...
    private func sync(state: SafeSwapTradeService.State) {
        var loading = false
        switch state {
        case .loading:
            loading = true
...
extension SafeSwapViewModel {
    ...
    var openConfirmSignal: Signal<SafeSwapParameters> {
        openConfirmRelay.asSignal()
    }
