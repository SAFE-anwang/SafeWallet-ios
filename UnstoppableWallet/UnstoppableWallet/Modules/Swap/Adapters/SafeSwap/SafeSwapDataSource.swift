...
//    private var lastPriceImpact: SafeSwapModule.PriceImpactViewItem?
...
//    }
//
//    private func handle(priceImpact: SafeSwapModule.PriceImpactViewItem?) {
...
//    }
//
//    private func handle(revokeActionState: SafeSwapViewModel.ActionState) {
...
//}
//
//extension SafeSwapDataSource: ISwapDataSource {
//
...
//}
//
//extension SafeSwapDataSource: IPresentDelegate {
//
...
//}
//
//extension SafeSwapDataSource: ISwapApproveDelegate {
//
//    func didApprove() {
...
//}
//
//extension SafeSwapDataSource: IDynamicHeightCellDelegate {
//
//    func onChangeHeight() {
//        onReload?()
//    }
...
class SafeSwapDataSource {
    ...
    private func openConfirm(parameters: SafeSwapParameters) {
        guard let viewController = SafeSwapConfirmationModule.viewController(parameters: parameters, dex: viewModel.service.dex) else {
            return
        }
        onOpen?(viewController, true)
    }
