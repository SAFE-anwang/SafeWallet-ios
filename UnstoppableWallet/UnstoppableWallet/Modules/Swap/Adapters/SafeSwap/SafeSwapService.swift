...
//
//    init(dex: SwapModule.Dex, tradeService: SafeSwapTradeService, allowanceService: SwapAllowanceService, pendingAllowanceService: SwapPendingAllowanceService, adapterManager: AdapterManager) {
//        self.dex = dex
...
//    }
//
//    private func onUpdateTrade(state: SafeSwapTradeService.State) {
//        syncState()
//    }
//
...
//}
//
//extension SafeSwapService: ISwapErrorProvider {
//
...
class SafeSwapService {
    ...
    init(dex: SwapModule.Dex, evmKit: EvmKit.Kit, tradeService: SafeSwapTradeService, allowanceService: SwapAllowanceService, pendingAllowanceService: SwapPendingAllowanceService, adapterManager: AdapterManager) {
        self.dex = dex
        self.tradeService = tradeService
        self.allowanceService = allowanceService
        self.pendingAllowanceService = pendingAllowanceService
    ...
    private func syncState() {
        ...
        var parameters: SafeSwapParameters?
