...
//    }
//
//    func priceImpactViewItem(trade: SafeSwapTradeService.Trade, minLevel: SafeSwapTradeService.PriceImpactLevel = .warning) -> SafeSwapModule.PriceImpactViewItem? {
...
//            return nil
//        }
//        return SafeSwapModule.PriceImpactViewItem(
//                value: "-" + priceImpact.description + "%",
//                level: impactLevel
//        )
//    }
//
//    func guaranteedAmountViewItem(tradeData: TradeData, tokenIn: MarketKit.Token?, tokenOut: MarketKit.Token?) -> SafeSwapModule.GuaranteedAmountViewItem? {
...
//            }
//
//            return SafeSwapModule.GuaranteedAmountViewItem(
...
//}
//
//extension SafeSwapViewItemHelper {
//
