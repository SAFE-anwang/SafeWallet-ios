...
struct LiquidityAddQuotesView: View {
    @ObservedObject var viewModel: LiquidityAddViewModel
    ...
    var body: some View {
        ThemeNavigationStack {
            ScrollableThemeView {
                VStack {
                    ForEach(viewModel.quotes, id: \.provider.id) { (quote: LiquidityAddViewModel.Quote) in
    ...
    private func quoteCoinValue(quote: LiquidityAddViewModel.Quote) -> String? {
