...
class BaseUniswapV2LiquiditySwapProvider: BaseUniswapLiquiditySwapProvider {
    ...
    override func trade(rpcSource: RpcSource, chain: Chain, token0 tokenIn: UniswapKit.Token, token1 tokenOut: UniswapKit.Token, amountIn: Decimal, tradeOptions: TradeOptions) async throws -> BaseUniswapLiquiditySwapQuote.Trade {
    ...
    override func transactionData(receiveAddress: EvmKit.Address, chain: Chain, trade: BaseUniswapLiquiditySwapQuote.Trade, tradeOptions _: TradeOptions) async throws -> TransactionData {
