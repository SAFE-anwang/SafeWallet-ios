...
class BaseUniswapLiquidityAddQuote: BaseEvmLiquidityAddQuote {
    let trade: Trade
    ...
    override var customButtonState: MultiSwapButtonState? {
        if let priceImpact = trade.priceImpact, BaseUniswapLiquidityAddProvider.PriceImpactLevel(priceImpact: priceImpact) == .forbidden {
        ...
        if let priceImpact = trade.priceImpact, BaseUniswapLiquidityAddProvider.PriceImpactLevel(priceImpact: priceImpact) != .negligible {
            fields.append(
                MultiSwapMainField(
                    ...
                    valueLevel: BaseUniswapLiquidityAddProvider.PriceImpactLevel(priceImpact: priceImpact).valueLevel
                )
            )
        }
