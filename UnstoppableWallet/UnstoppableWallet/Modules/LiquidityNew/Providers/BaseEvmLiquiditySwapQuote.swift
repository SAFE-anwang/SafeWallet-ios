...
class BaseEvmLiquiditySwapQuote: ILiquiditySwapQuote {
    let allowanceState: LiquiditySwapAllowanceHelper.AllowanceState

    init(allowanceState: LiquiditySwapAllowanceHelper.AllowanceState) {
