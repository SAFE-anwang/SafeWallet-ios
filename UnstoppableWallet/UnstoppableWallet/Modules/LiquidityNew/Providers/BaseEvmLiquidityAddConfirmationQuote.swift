...
class BaseEvmLiquidityAddConfirmationQuote: BaseSendEvmData, ILiquidityAddConfirmationQuote {
    ...
    func additionalFeeFields(token0: Token, token1: Token, baseToken: Token, currency: Currency, token0Rate: Decimal?, token1Rate: Decimal?, baseTokenRate: Decimal?) -> [SendField] {
        []
    }
}
