...
class BaseUniswapV3LiquidityAddProvider: BaseUniswapLiquidityAddProvider {
    ...
    override func trade(rpcSource: RpcSource, chain: Chain, token0: UniswapKit.Token, token1: UniswapKit.Token, amountIn: Decimal, tradeOptions: TradeOptions) async throws -> BaseUniswapLiquidityAddQuote.Trade {
    ...
    override func transactionData(receiveAddress: EvmKit.Address, chain: Chain, trade: BaseUniswapLiquidityAddQuote.Trade, tradeOptions: TradeOptions) async throws -> TransactionData {
