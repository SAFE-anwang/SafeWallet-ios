...
public protocol ILiquidityAddProvider {
    var id: String { get }
    var name: String { get }
    var icon: String { get }
    ...
    func confirmationQuote(token0: Token, token1: Token, amount0: Decimal, amount1: Decimal?, transactionSettings: TransactionSettings?) async throws -> LiquidityAddFinalQuote
