                ...
                NftV2CollectionView(
                    ...
                    onSend: { asset in
                        ...
                        let controller = await viewModel.validatedSendController(
                            asset: asset,
                            collection: collection,
                            onSendSuccess: { accountId, asset, collection, transactionHash, amount in
                                viewModel.handleSendSuccess(accountId: accountId, asset: asset, collection: collection, transactionHash: transactionHash, amount: amount)
                                Task { @MainActor in
